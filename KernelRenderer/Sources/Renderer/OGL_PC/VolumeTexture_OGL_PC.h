...
//	The VOLUME_TEXTURE_OGL_PC class implements ...
//
...
#ifndef __KRENDERER_RENDERER_OGL_PC_VOLUME_TEXTURE_OGL_PC_H__
#define __KRENDERER_RENDERER_OGL_PC_VOLUME_TEXTURE_OGL_PC_H__
...
namespace	QDT
{
	namespace	KRENDERER
	{
		class VOLUME_TEXTURE_OGL_PC : public I_TEXTURE
		{
		public:

			VOLUME_TEXTURE_OGL_PC(UInt32 uiWidth, UInt32 uiHeight, UInt32 uiDepth, PIXEL_FORMAT eFormat, UInt32 nMipMapLevels);
			~VOLUME_TEXTURE_OGL_PC();
			...
			virtual UInt32	GetTarget() const { return GL_TEXTURE_3D; }
...
#endif // __KRENDERER_RENDERER_OGL_PC_VOLUME_TEXTURE_OGL_PC_H__
