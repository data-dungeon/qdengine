...
//
//	CLASS:	TEXTURE_PSGL
//	The TEXTURE_PSGL class implements ...
//
...
#ifndef __KRENDERER_TEXTURE_PSGL_H__
#define __KRENDERER_TEXTURE_PSGL_H__
...
namespace	QDT
{
	namespace	KRENDERER
	{
		class TEXTURE_PSGL : public I_TEXTURE
		{
		public:

			TEXTURE_PSGL();
			TEXTURE_PSGL(UInt32 uiWidth, UInt32 uiHeight, PIXEL_FORMAT eFormat, UInt32 nMipMapLevels);
			~TEXTURE_PSGL();
			...
			virtual UInt32	GetTarget() const { return GL_TEXTURE_2D; }
		...
		private:
			...
			friend class RENDER_TARGET_PSGL;
...
#endif // __KRENDERER_TEXTURE_PSGL_H__
