...
//	The VOLUME_TEXTURE_PSGL class implements ...
//
...
#ifndef __KRENDERER_RENDERER_VOLUME_TEXTURE_PSGL_H__
#define __KRENDERER_RENDERER_VOLUME_TEXTURE_PSGL_H__
...
namespace	QDT
{
	namespace	KRENDERER
	{
		class VOLUME_TEXTURE_PSGL : public I_TEXTURE
		{
		public:

			VOLUME_TEXTURE_PSGL(UInt32 uiWidth, UInt32 uiHeight, UInt32 uiDepth, PIXEL_FORMAT eFormat, UInt32 nMipMapLevels);
			~VOLUME_TEXTURE_PSGL();
...
#endif // __KRENDERER_RENDERER_VOLUME_TEXTURE_PSGL_H__
