...
#include "Root.h"
#include INCL_KINPUT(Input/PS3/forinput)
...
bool FOR_INPUT::Init()
{
	...
	int					j;
	QDT_STRING			sName;
	INPUT_INIT_INFO_PS3	initInfo;

	PAD_MANAGER_PS3::GetInstance()->Init();

	NbSlot = PAD_MANAGER_PS3::GetInstance()->GetNbPadMax();
...
{
	//PS3 process
	PAD_MANAGER_PS3::GetInstance()->Update();
...
{
	PAD_MANAGER_PS3::GetInstance()->Close();
