...
//	The IHM_ELEMENT_QUAD_DESC class implements ...
//
...
class	IHM_ELEMENT_QUAD_DESC : public IHM_ELEMENT_POLY_ABC_DESC
{
public:
...
private:
	...
	/** Constructor */
	IHM_ELEMENT_QUAD_DESC();
 	/** Destructor */
    ~IHM_ELEMENT_QUAD_DESC();

   	/** For singleton : instance */
	static IHM_ELEMENT_QUAD_DESC*	_pInstance;
