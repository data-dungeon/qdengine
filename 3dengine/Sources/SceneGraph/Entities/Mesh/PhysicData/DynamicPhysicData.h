...
//	The DYNAMIC_PHYSIC_DATA class implements ...
//
...
#ifndef __M3D_SCENEGRAPH_ENTITIES_MESH_PHYSICDATA_DYNAMICPHYSICDATA_H__
#define __M3D_SCENEGRAPH_ENTITIES_MESH_PHYSICDATA_DYNAMICPHYSICDATA_H__
...
namespace QDT
{
	namespace M3D
	{
		class	DYNAMIC_PHYSIC_DATA : public COMMUNICATOR
		{
		public:
			...
			_INLINE_ Bool						IsKinematic() const;
			...
			_INLINE_ void	SetKinematic(Bool bKinematic);
...
#endif // __M3D_SCENEGRAPH_ENTITIES_MESH_PHYSICDATA_DYNAMICPHYSICDATA_H__
