...
#ifndef __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_RADIALFIELD_H__
#define __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_RADIALFIELD_H__
...
namespace QDT
{
	namespace M3D
	{
		class RADIAL_FIELD : public FORCE_FIELD_ABC
		{
		public:

			enum
			{
				CMD_RADIAL_FIELD_LAST = CMD_FORCE_FIELD_LAST,
			};

			explicit		RADIAL_FIELD();
							~RADIAL_FIELD();
...
#endif // __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_RADIALFIELD_H__
