...
#ifndef __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_VORTEXFIELD_H__
#define __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_VORTEXFIELD_H__
...
namespace QDT
{
	namespace M3D
	{
		class VORTEX_FIELD : public FORCE_FIELD_ABC
		{
		public:

			enum
			{
				CMD_VORTEX_FIELD_LAST = CMD_FORCE_FIELD_LAST,
			};

			explicit		VORTEX_FIELD();
							~VORTEX_FIELD();
...
#endif // __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_VORTEXFIELD_H__
