...
#ifndef __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_UNIFORMFIELD_H__
#define __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_UNIFORMFIELD_H__
...
namespace QDT
{
	namespace M3D
	{
		class UNIFORM_FIELD : public FORCE_FIELD_ABC
		{
		public:

			enum
			{
				CMD_UNIFORM_FIELD_LAST = CMD_FORCE_FIELD_LAST,
			};

			explicit		UNIFORM_FIELD();
							~UNIFORM_FIELD();
...
#endif // __M3D_SCENEGRAPH_ENTITIES_FORCEFIELDS_UNIFORMFIELD_H__
