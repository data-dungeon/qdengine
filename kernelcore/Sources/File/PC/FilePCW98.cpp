...
//-----------------------------------------------------------------------------
//	Name:		FILE_PC_W98 constructor
//	Object:		
//	02-02-14:	AMA - Created
//-----------------------------------------------------------------------------
FILE_PC_W98::FILE_PC_W98()
{
	_nReadSize = 0;
	_nReadPos = 0;
	_nCurPos = 0;
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Open(const char * const	pFileName,
						  const F_MODE			eMode,
						  const bool			bSharing)
{
...
//	02-02-18:	AMA - Created
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Close()
{
	QDT_ASSERT( TestStatus(F_STATUS::FS_OPEN) );

	if ( TestStatus(F_STATUS::FS_OPEN) )
	{
		int nErr;
...
//	02-02-18:	AMA - Created
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::IsExist(const char * const	pFileName) const
{
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::IsWriteProtected(const char * const	pFileName) const
{
	WIN32_FIND_DATA FindFile;
	HANDLE handle = FindFirstFile(pFileName, &FindFile);
	if (handle == INVALID_HANDLE_VALUE)
...
//	02-02-18:	AMA - Created
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Seek(const F_SEEK	eInitialPosition,
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Read(void *				pBuffer,
...
//	02-02-20:	AMA - Created
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::ReadInternal(void *				pBuffer,
								  const unsigned int	nPosition,
								  const int				nSize,
								  const F_SYNC			eSync)
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Write(void *		pBuffer,
						  const unsigned int		nPosition,
						  const int		nSize,
						  const F_SYNC	eSync)
...
//	02-02-20:	AMA - Created
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Delete(const char * const	pFileName) const
{
	QDT_NOT_IMPLEMENTED();
	return ( false );
}
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::Rename(const char * const	pFileName) const
{
	QDT_NOT_IMPLEMENTED();
	return ( false );
}
...
//-----------------------------------------------------------------------------
bool	FILE_PC_W98::IsIdle() const
{
	((FILE_PC_W98*)this)->UpdateRead();
...
//	03-05-22:	VMA - Created
//-----------------------------------------------------------------------------
int		FILE_PC_W98::GetSectorSize() const
{
	return (SECTOR_SIZE);
}
...
//-----------------------------------------------------------------------------
void	FILE_PC_W98::SetName(const QDT_STRING &	sName)
{
	_sName = sName;
}
...
//	03-09-10:	VPI - Created
//-----------------------------------------------------------------------------
const QDT_STRING &	FILE_PC_W98::GetName() const
{
	return	(_sName);
}
...
//-----------------------------------------------------------------------------
unsigned int	FILE_PC_W98::GetCurrentReadPosition() const
{
